...
function createSuite() {
  function suiteFn(name, factoryOrOptions, optionsOrFactory) {
    ...
    options = {
      ...
      ...options,
      shuffle: this.shuffle ?? options.shuffle ?? ((_a2 = currentSuite == null ? void 0 : currentSuite.options) == null ? void 0 : _a2.shuffle) ?? (runner == null ? void 0 : runner.config.sequence.shuffle)
    };
...
// src/services/tests/search-gym.spec.ts
...
describe("Search many gyms service", () => {
  ...
  it("should be able to search for gyms", async () => {
    await gymRepository.create({
      ...
      description: "",
      phone: "(00) 12345-8789",
      latitude: new import_library.Decimal(-22.0412209),
      longitude: new import_library.Decimal(-47.9119285)
    });
    await gymRepository.create({
      id: "gym-2",
      title: "Dev Gym",
      description: "",
      phone: "(00) 12345-8789",
      latitude: new import_library.Decimal(-23.0412209),
      longitude: new import_library.Decimal(-48.9119285)
    });
    ...
    globalExpect(gyms).toEqual([globalExpect.objectContaining({ title: "Fitness Gym" })]);
  });
  it("should be able to fetch paginated search gyms", async () => {
    ...
    globalExpect(gyms).toEqual([
      globalExpect.objectContaining({ title: "Fitness Gym-21" }),
      globalExpect.objectContaining({ title: "Fitness Gym-22" })
    ]);
  });
});
