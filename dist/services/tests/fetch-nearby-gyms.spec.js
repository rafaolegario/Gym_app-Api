...
// src/services/tests/fetch-nearby-gyms.spec.ts
...
describe("Fetch nearby gyms service", () => {
  ...
  it("should be able to search for gyms", async () => {
    await gymRepository.create({
      ...
      description: "",
      phone: "(00) 12345-8789",
      latitude: new import_library.Decimal(-22.0141078),
      longitude: new import_library.Decimal(-47.8524877)
    });
    await gymRepository.create({
      id: "gym-2",
      title: "Far Gym",
      description: "",
      phone: "(00) 12345-8789",
      latitude: new import_library.Decimal(-21.903246),
      longitude: new import_library.Decimal(-47.843433)
    });
